...
contract CrossVmProxyReverse {
    ...
    function deposit(bytes32 moveReceiver, uint256 amount) external {
        ...
        crossVM.callMove(handler, "cross_vm_coin_reverse_demo", "deposit", data, coinType);
    }
