...
from funding_utils_local import approve_eth_custom_coin, fund_npc_accounts_custom_coin_aptos, fund_npc_accounts_custom_coin_eth, fund_npc_accounts_native_coin_aptos, fund_npc_accounts_native_coin_eth, register_custom_coin_pancakeswap_native
...
async def generate_txs():
    ...
    with open(f"./transaction_batches/salad_pancake_custom15_pancake15_erc70_{num_of_txs // K}k.txt", "wb") as f:
        for _ in range(num_of_txs):
