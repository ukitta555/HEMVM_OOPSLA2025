...
contract CrossVmProxy {
    ...
    function deposit(bytes32 moveReceiver, uint256 amount) external {
        ...
        crossVM.callMove(handler, "cross_vm_coin", "deposit", data, coinType);
    }
    ...
    function requireBuiltinCaller(string memory caller) view internal {
        ...
        require(keccak256(bytes(caller)) == keccak256(bytes("0x5f61e930582ca112420399eaac4d224aba550789bd31dbe3d8835abac4267b06::cross_vm_coin::CallType")), "Incorrect sender");
    }
    ...
    // need some unique identifier as a coinType replacement
    // address would be a good idea most likely....
