module coin_wrapper::native_coin {
    ...
    public entry fun transfer(account: &signer, receiver: address, amount: u64) {
        // debug::print(&string::utf8(b"Transferring money in native coin"));
        // debug::print(&string::utf8(b"Balance before:"));
        // debug::print(&coin::balance<DiemCoin>(signer::address_of(account)));
        coin::deposit(receiver, coin::withdraw<DiemCoin>(account, amount));
        // debug::print(&string::utf8(b"Transferring money in native coin"));
