...
#![forbid(unsafe_code)]
use crate::{
    executor::src::components::{block_tree::BlockTree, chunk_output::ChunkOutput},
    executor::src::logging::{LogEntry, LogSchema},
};
use anyhow::Result;
    ...
    V: VMExecutor,
{
    ...
    fn execute_block(
        ...
        println!("Executing block of size {}", block.1.len());
