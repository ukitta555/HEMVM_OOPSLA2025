...
pub(crate) mod block_version_by_hash;
...
pub(crate) mod transaction_by_eth_hash;
...
pub const BLOCK_VERSION_BY_HASH_CF_NAME: ColumnFamilyName = "block_version_by_hash";
...
pub const TRANSACTION_BY_ETH_HASH_CF_NAME: ColumnFamilyName = "transaction_by_eth_hash";
