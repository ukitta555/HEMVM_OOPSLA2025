...
use aptos_block_executor::{
    cached_state_view::CachedStateView, state_delta::StateDelta, state_view::{DbReader, StateSnapshotReceiver},
};
use aptos_storage_interface::sync_proof_fetcher::SyncProofFetcher;
use aptos_types::{
