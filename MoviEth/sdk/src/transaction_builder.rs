...
use aptos_types::transaction::{authenticator::AuthenticationKeyPreimage, EntryFunction, ModuleBundle, Script};
...
#[derive(Clone, Debug)]
pub struct EthTransactionFactory {
    max_gas_amount: u64,
    gas_unit_price: u64,
...
impl EthTransactionFactory {
    ...
    // pub fn create_user_account(&self, public_key: &Secp256k1PublicKey) -> TransactionBuilder {
