...
use aptos_block_executor::{executor::TwoWayChannels, VMExecutor};
use fail::fail_point;
    ...
    V: VMExecutor,
{
    ...
    pub fn execute_block_benchmark_prototype
    (
        &self,
    ...
    V: VMExecutor,
{
    ...
    // where
        // E: ExecutorTask<Txn = PreprocessedTransaction> + ExecutorTask<Argument = &'a CachedStateView> + ExecutorTask<Output = AptosTransactionOutput> + ExecutorTask<Error = VMStatus>
    {
        ...
        let output = if parent_block_id != committed_block.id && parent_output.has_reconfiguration()
        {
            ...
            let chunk_output: ChunkOutput = {
                ...
                ChunkOutput::by_transaction_execution_prototype::<V>(
                    transactions,
                    state_view,
                    channels,
                    previous_nonce_per_address
