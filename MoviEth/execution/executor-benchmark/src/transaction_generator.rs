...
pub fn get_progress_bar(num_accounts: usize) -> ProgressBar {
...
pub fn get_sequence_number_aptos(address: AccountAddress, reader: Arc<dyn DbReader>) -> u64 {
...
impl TransactionGenerator {
    ...
    fn gen_seed_account_cache(reader: Arc<dyn DbReader>, num_accounts: usize) -> AccountCache {
        ...
        for account in &mut accounts.accounts {
            *account.sequence_number_mut() = get_sequence_number_aptos(account.address(), reader.clone());
        }
        accounts
    }
