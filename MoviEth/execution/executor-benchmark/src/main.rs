...
fn main() {
    ...
    match opt.cmd {
        ...
        Command::CreateDbEth {
            ...
            println!("create db eth");
            aptos_executor_benchmark::eth_db_generator::run_eth_create_db(
                num_accounts,
                init_account_balance,
                opt.block_size,
                data_dir,
