...
use aptos_framework::natives::{
    aggregator_natives::NativeAggregatorContext, call_evm::CrossVMContext, code::NativeCodeContext,
...
impl MoveVmExt {
        ...
        Ok(Self {
            inner: MoveVM::new_with_config(
                ...
                VMConfig {
                    ...
                    paranoid_type_checks: AptosVM::get_paranoid_checks(),
                },
            )?,
            chain_id,
        })
    ...
    pub fn new_session_with_evm_ref<'r, S: MoveResolverExt>(
        &self,
        remote: &'r S,
        session_id: SessionId,
        evm_caller: CrossVMContext<'r>,
    ) -> SessionExt<'r, '_, S> {
        self.new_session_inner(remote, session_id, Some(evm_caller))
    }
    ...
    pub fn new_session<'r, S: MoveResolverExt>(
        ...
        self.new_session_inner(remote, session_id, None)
    }

    fn new_session_inner<'r, S: MoveResolverExt>(
        &self,
        remote: &'r S,
        session_id: SessionId,
        evm_caller: Option<CrossVMContext<'r>>,
    ) -> SessionExt<'r, '_, S> {
