...
pub const MAX_APPLICATION_MESSAGE_SIZE: usize =
    (MAX_MESSAGE_SIZE_NETWORK_CONFIG - MAX_MESSAGE_METADATA_SIZE) - MESSAGE_PADDING_SIZE; /* The message size that applications should check against */
pub const MAX_FRAME_SIZE: usize = 4 * 1024 * 1024; /* 4 MiB large messages will be chunked into multiple frames and streamed */
pub const MAX_MESSAGE_SIZE_NETWORK_CONFIG: usize = 64 * 1024 * 1024; /* 64 MiB */
...
impl NetworkConfig {
    pub fn network_with_id(network_id: NetworkId) -> NetworkConfig {
        ...
        let mut config = Self {
            ...
            max_message_size: MAX_MESSAGE_SIZE_NETWORK_CONFIG,
