...
fn test_overlay_account_create() {
    ...
    let account = Account::from_contract_account(contract_addr, ContractAccount {
        balance: 101.into(),
        nonce: 55.into(),
...
fn test_clone_overwrite() {
    ...
    let account1 = Account::from_contract_account(address, ContractAccount {
        balance: 1000.into(),
        nonce: 123.into(),
        code_hash: KECCAK_EMPTY,
    ...
    let account2 = Account::from_contract_account(address, ContractAccount {
        balance: 1001.into(),
        nonce: 124.into(),
        code_hash: KECCAK_EMPTY,
