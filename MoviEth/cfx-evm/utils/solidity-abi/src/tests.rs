...
fn test_vector_in_vector() {
    let data: Vec<Vec<U256>> = vec![vec![U256::from(17), U256::from(18)], vec![
        U256::from(19),
        U256::from(20),
        U256::from(21),
    ]];
...
fn test_static_array_in_array() {
    let data: [[U256; 2]; 2] = [[U256::from(17), U256::from(18)], [
        U256::from(19),
        U256::from(20),
    ]];
    let encoded = data.abi_encode();
...
fn test_array_in_vector() {
    let data: Vec<[U256; 2]> = vec![[U256::from(17), U256::from(18)], [
        U256::from(19),
        U256::from(20),
    ]];
    let encoded = data.abi_encode();
...
fn test_vector_in_array() {
    let data: [Vec<U256>; 2] = [vec![U256::from(17), U256::from(18)], vec![
        U256::from(19),
        U256::from(20),
    ]];
    let encoded = data.abi_encode();
...
fn test_strange_input() {
    ...
    let output = (vec![U256::from(1), U256::from(2)], vec![
        U256::from(3),
        U256::from(4),
    ]);
    assert_eq!(
