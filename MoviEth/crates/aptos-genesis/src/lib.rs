...
use aptos_types::{
    ...
    transaction::{EthAddress, Transaction},
    waypoint::Waypoint,
};
...
pub struct GenesisInfo {
    ...
    pub maybe_evm_genesis_account: Option<EthAddress>,
    pub maybe_move_genesis_account: Option<AccountAddress>,
}
...
impl GenesisInfo {
    pub fn new(
        ...
        Ok(GenesisInfo {
            ...
            maybe_evm_genesis_account: genesis_config.maybe_evm_genesis_account.clone(),
            maybe_move_genesis_account: genesis_config.maybe_move_genesis_account.clone(),
        })
    }
    ...
    fn generate_genesis_txn(&self) -> Transaction {
        aptos_vm_genesis::encode_genesis_transaction(
            ...
            &self.gas_schedule,
            self.maybe_evm_genesis_account,
            self.maybe_move_genesis_account
        )
    }
