...
use aptos_api_types::{
    ...
    MultiEd25519Signature as APIMultiEd25519Signature, Secp256k1Signature as APISecp251k1Signature,
    TransactionSignature as APITransactionSignature, TransactionSignature,
};
...
impl Signature {
    ...
    pub fn from_user_transaction(
        ...
        match s {
            ...
            APITransactionSignature::Secp256k1Signature(sig) => {
                Ok(vec![Self::parse_single_secp256k1_signature(
                    sig,
                    sender,
                    transaction_version,
                    transaction_block_height,
    ...
    pub fn get_signature_type(t: &APITransactionSignature) -> String {
        match t {
            ...
            TransactionSignature::Secp256k1Signature(_) => String::from("secp256k1_signature"),
        }
    }
    ...
    fn parse_single_secp256k1_signature(
        s: &APISecp251k1Signature,
        sender: &String,
        transaction_version: i64,
        transaction_block_height: i64,
        is_sender_primary: bool,
    ...
    fn parse_multi_agent_signature_helper(
        ...
        match s {
            ...
            APIAccountSignature::Secp256k1Signature(sig) => {
                vec![Self::parse_single_secp256k1_signature(
                    sig,
                    sender,
                    transaction_version,
                    transaction_block_height,
