...
impl TransactionsApi {
    ...
    async fn stress_test_move(
        ...
        // Vlad: should we create a separate data structure of NPC accounts to track nonces or should we put everything inside one DS?
    ...
    // IMPORTANT (Vlad): transaction submission endpoint
    #[oai(
        path = "/transactions",
        method = "post",
